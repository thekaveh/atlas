...
Upstream requires Neo4j 5.23 or later with APOC installed. Atlas pins Neo4j 5.26.x, but APOC is **not** preinstalled (the image is plain `neo4j:5.26.30`; see [services/neo4j/README.md](../neo4j/README.md)). APOC procedures must be enabled before Graph Builder's APOC-dependent operations will work.

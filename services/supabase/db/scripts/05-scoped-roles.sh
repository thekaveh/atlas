...
TRUEFORGE_DB_USER TRUEFORGE_DB_PASSWORD TRUEFORGE_DB_NAME
...
LANGFUSE_DB_USER TRUEFORGE_DB_USER MLFLOW_DB_USER LABEL_STUDIO_DB_USER ICEBERG_DB_USER
...
TRUEFORGE_DB_NAME MLFLOW_DB_NAME LABEL_STUDIO_DB_NAME ATLAS_ICEBERG_DB_NAME ATLAS_SUPAVISOR_DB_NAME'
...
ensure_restricted_login "$TRUEFORGE_DB_USER" "$TRUEFORGE_DB_PASSWORD"
...
ensure_database "$TRUEFORGE_DB_NAME" "$TRUEFORGE_DB_USER"

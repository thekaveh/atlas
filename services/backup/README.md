...
- `database-snapshots.sh` — validates the exact Neo4j 5.26.30 offline dump, drives Weaviate 1.38.13's native filesystem backup API to `SUCCESS`, and emits signed version/checksum/completeness metadata.

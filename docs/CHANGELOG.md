...
### 1.1. Changed — 2026-08-23 — Wizard TUI moved to Textual 8.2.8; log pane and command summary are now drag-selectable (#535 Pass 0/1)
...
### 1.2. Security — 2026-08-22 — Airflow base image and two runtime locks carried patched advisories
...
### 1.3. Fixed — 2026-08-22 — The wizard's Ollama picker hid every model below the one you expanded
...
### 1.4. Fixed — 2026-08-22 — The three-surface docs gate validated a tree it never produced
...
### 1.5. Fixed — 2026-08-22 — Supabase tables were readable and writable without authentication
...
### 1.6. Fixed — 2026-08-22 — Every Supabase call through Kong returned 401
...
### 1.7. Fixed — 2026-08-20 — A consumer's managed host process could SIGKILL an unrelated process group
...
### 1.8. Security — 2026-08-20 — A consumer manifest could hijack any generated secret
...
### 1.9. Fixed — 2026-08-20 — Env backfill silently undid a deselect-all
...
### 1.10. Fixed — 2026-08-20 — Two consumer-manifest parsing defects
...
### 1.11. Fixed — 2026-08-20 — `.env` snapshot retention could be silently disabled
...
### 1.12. Fixed — 2026-08-20 — Subprocess output decoded with the ambient locale, crashing on one non-ASCII byte
...
### 1.13. Fixed — 2026-08-20 — `.env` snapshots accumulated without bound
...
### 1.14. Fixed — 2026-08-20 — #935 left the retired `qwen3.6` default in 26 places
...
### 1.15. Fixed — 2026-08-20 — The MCP notebook raised `NameError` for every reader
...
### 1.16. Documentation — 2026-08-20 — The changelog's `[Unreleased]` section read oldest-first at the bottom
...
### 1.17. Fixed — 2026-08-16 — The documentation landing page overstated the platform and under-rendered the tracks
...
### 1.18. Fixed — 2026-08-15 — `blender-mcp stop` could SIGKILL an unrelated process
...
### 1.19. Fixed — 2026-08-15 — The docs CI check failed on transient asset fetches, and never said so
...
### 1.20. Fixed — 2026-08-15 — `blender-mcp stop` reported failure for a process it had just killed
...
### 1.21. Added — 2026-08-15 — Consumers can declare their own managed host process (#795)
...
### 1.22. Added — 2026-08-14 — The Logs tab says when it is holding an error (#912)
...
### 1.23. Added — 2026-08-11 — Host-Ollama residency: stop a multi-model run evicting its own working set (#798)
...
### 1.24. Changed — 2026-08-11 — Default Ollama content/vision model moves to qwen3.8
...
### 1.25. Changed — 2026-08-10 — Bounded the response cache, protected the Redis queues, quantized Ollama's KV cache
...
### 1.26. Fixed — 2026-08-10 — Langfuse tracing was shipping to the public cloud; langfuse-web never went healthy (#928, #929)
...
### 1.27. Changed — 2026-08-09 — Track matrix collapsed to one generated home (#838)
...
### 1.28. Added — 2026-08-09 — Ollama parallel-serving doctor lint for host daemons (#849)
...
### 1.29. Fixed — 2026-08-09 — Wizard tab follow-ups from the #911 review (#912)
...
### 1.30. Fixed — 2026-08-09 — comfyui-krea2edit was provisionable but inert (#909)
...
### 1.31. Fixed — 2026-08-08 — Wizard UX pass from a live run (tabs, prompts, stop, base port)
...
### 1.32. Fixed — 2026-08-08 — Runtime-lock advisory refresh (pypdf, GitPython, lightning)
...
### 1.33. Changed — 2026-08-07 — Wizard splits into Setup and Logs tabs
...
### 1.34. Fixed — 2026-08-07 — Wizard command summary overflowed with many services
...
### 1.35. Added — 2026-08-05 — Consumer-declared ComfyUI custom nodes + managed-MPS install (#905)
...
### 1.36. Fixed — 2026-08-05 — Wizard Ctrl+Q detach after a launch failure
...
### 1.37. Fixed — 2026-08-05 — Backend memory/research resilience
...
### 1.38. Fixed — 2026-08-05 — Research-sources cascade-delete index
...
### 1.39. Fixed — 2026-08-05 — JupyterHub empty-notebook-dir crash-loop guard
...
### 1.40. Fixed — 2026-08-05 — Provider startup, bounded-subprocess, and supply-chain hardening
...
### 1.41. Added — 2026-07-19 — Managed headless Blender MCP source
...
### 1.42. Added — 2026-07-19 — Host model pulls for `ollama-localhost`
...
### 1.43. Added — 2026-07-19 — Endpoint exports for host media directories and the Blender bridge
...
### 1.44. Added — 2026-07-19 — Managed-MPS ComfyUI model provisioning
...
### 1.45. Added — 2026-07-19 — Declarative deployment profiles
...
### 1.46. Added — 2026-07-19 — Durable host-adaptive `<SVC>_SOURCE: auto`
...
### 1.47. Fixed — 2026-07-15 — Startup and API safety boundaries
...
### 1.48. Added — 2026-07-13 — ComfyUI media-gateway provider
...
### 1.49. Fixed — 2026-07-13 — Synchronized three-surface documentation
...
### 1.50. Added — 2026-07-10 — Consumer manifest registration
...
### 1.51. Added — 2026-07-10 — Consumer overlay doctor
...
### 1.52. Added — 2026-07-10 — Headless consumer validation commands
...
### 1.53. Added — 2026-07-10 — Non-following start for automation
...
### 1.54. Added — 2026-07-10 — MinIO parent-owned consumer buckets
...
### 1.55. Documentation — 2026-07-10 — Consumer reference layout
...
### 1.56. Added — 2026-07-10 — Ragas RAG evaluation surface
...
### 1.57. Added — 2026-07-10 — Chonkie RAG chunking surface
...
### 1.58. Added — 2026-07-10 — External consumer env overlay
...
### 1.59. Added — 2026-07-09 — Asset worker glTF post-processing service
...
### 1.60. Added — 2026-07-09 — Hosted media gateway foundation
...
### 1.61. Added — 2026-07-09 — ComfyUI pinned core + custom-node provisioning
...
### 1.62. Added — 2026-07-09 — ComfyUI model-bundle catalog foundation
...
### 1.63. Fixed — 2026-07-07 — overnight maintenance: init quoting, bootstrapper/backend hardening, latent SQL abort
...
### 1.64. Added — 2026-07-05 — FAL cloud media provider + backend Kong auth + user Supabase migration slot
...
### 1.65. Fixed — 2026-07-05 — backend plugin requirements + install-error surfacing + env-overlay cold-start preservation
...
### 1.66. Added — 2026-07-03 — Atlas root dashboard
...
### 1.67. Fixed — 2026-07-02 — overnight maintenance hardening
...
### 1.68. Changed — 2026-06-29 — SearXNG: thin `use_default_settings` override instead of a forked settings.yml
...
### 1.69. Fixed — 2026-06-28 — post-launch service error-log cleanup (realtime crash + 3 noisy services)
...
### 1.70. Fixed — 2026-06-28 — lightrag-init `password authentication failed` — pipeline ordering (the real "stale volume" cause)
...
### 1.71. Fixed — 2026-06-28 — Cold start now regenerates the volume-baked DB passwords
...
### 1.72. Fixed — 2026-06-28 — Launch pipeline crash on the embedding dimension warning (`'function' object has no attribute 'print'`)
...
### 1.73. Fixed — 2026-06-28 — Wizard "default for chat" no longer lists embedding models
...
### 1.74. Changed — 2026-06-28 — Image-pin sweep: kill moving tags, refresh stale pins (#168 / #169 / #170)
...
### 1.75. Changed — 2026-06-28 — Batched safe Dependabot dependency-floor bumps (#167)
...
### 1.76. Added — 2026-06-27 — Brand-overridable block-art logo (`BRAND_LOGO_FILE`)
...
### 1.77. Changed — 2026-06-27 — Model catalog source-of-truth: Supabase DB → per-service YAML
...
### 1.78. Fixed — 2026-06-27 — Model-SoT follow-ups
...
### 1.79. Added — 2026-06-21 — Phase 1 reuse mechanics (`services/_user/` auto-launch + release tags)
...
### 1.80. Added — 2026-06-20 — Cloudflare Tunnel service (`cloudflared`)
...
### 1.81. Added — 2026-06-20 — On-demand backup runner (`backup`)
...
### 1.82. Added — 2026-06-20 — Secrets hygiene guard + cross-OS doc accuracy
...
### 1.83. Added — 2026-06-20 — Production-hardening profile (`--profile prod`)
...
### 1.84. Changed — 2026-06-20 — Atlas startup artwork gated behind a master switch (off by default)
...
### 1.85. Added — 2026-06-18 — Atlas brand identity: logo, wizard splash, poster
...
### 1.86. Changed — 2026-06-16 — Project renamed: GenAI Vanilla → Atlas
...
### 1.87. Fixed — 2026-06-16 overnight maintenance pass
...
### 1.90. Fixed — 2026-06-14 overnight maintenance pass (18 commits, passes 1-42)
...
### 1.91. Fixed — 2026-06-13 overnight maintenance pass (15 commits, passes 1-50)
...
### 1.92. Fixed — 2026-06-11 overnight maintenance passes 56-62 (7 commits)
...
### 1.93. Fixed — 2026-06-11 overnight maintenance passes 50-55 (5 commits)
...
### 1.94. Fixed — 2026-06-11 overnight maintenance passes 46-49 (5 commits)
...
### 1.95. Fixed — 2026-06-11 overnight maintenance passes 40-45 (6 commits)
...
### 1.96. Fixed — 2026-06-10 overnight maintenance passes 35-39 (6 commits)
...
### 1.97. Fixed — 2026-06-10 overnight maintenance pass 34 (1 commit)
...
### 1.98. Fixed — 2026-06-10 overnight maintenance passes 32-33 (2 commits)
...
### 1.99. Fixed — 2026-06-10 overnight maintenance passes 27-31 (5 commits)
...
### 1.100. Fixed — 2026-06-10 overnight maintenance pass 26 (1 commit)
...
### 1.101. Fixed — 2026-06-10 overnight maintenance passes 21-25 (4 commits)
...
### 1.102. Fixed — 2026-06-10 overnight maintenance pass 20 (1 commit)
...
### 1.103. Fixed — 2026-06-10 overnight maintenance pass 19 (1 commit)
...
### 1.104. Fixed — 2026-06-10 overnight maintenance passes 16-18 (3 commits)
...
### 1.105. Fixed — 2026-06-10 overnight maintenance pass 13 (1 commit)
...
### 1.106. Fixed — 2026-06-10 overnight maintenance pass 12 (1 commit)
...
### 1.107. Fixed — 2026-06-10 overnight maintenance pass 11 (1 commit)
...
### 1.108. Fixed — 2026-06-10 overnight maintenance pass 9 (1 commit)
...
### 1.109. Fixed — 2026-06-10 overnight maintenance pass 8 (1 commit)
...
### 1.110. Fixed — 2026-06-10 overnight maintenance pass 7 (1 commit)
...
### 1.111. Fixed — 2026-06-10 overnight maintenance pass 6 (1 commit)
...
### 1.112. Fixed — 2026-06-10 overnight maintenance pass 5 (2 commits)
...
### 1.113. Fixed — 2026-06-10 overnight maintenance pass 4 (2 commits)
...
### 1.114. Fixed — 2026-06-10 overnight maintenance pass 3 (5 commits)
...
### 1.115. Fixed — 2026-06-10 overnight maintenance pass 2 (6 commits)
...
### 1.116. Fixed — 2026-06-10 overnight maintenance pass 1 (18 commits)
...
### 1.117. Changed — 2026-06-10 overnight maintenance pass 1
...
### 1.118. Fixed — Critical bugs caught by the 2026-06-08 overnight audit
...
### 1.119. Fixed — Init container resilience (7 unbounded loops)
...
### 1.120. Fixed — Documentation drift (MinIO ports, TEI memory guide)
...
### 1.121. Fixed — Build & supply-chain hygiene
...
### 1.122. Tests — Structural regression guards
...
### 1.123. Docs — Top-level architecture diagram refreshed
...
### 1.124. Security — Auto-rotate 8 weak credential placeholders on first launch
...
### 1.125. Fixed — start.py cold-start port-clear + TUI launch flag pass-through
...
### 1.126. Fixed — LightRAG init resilience + open-webui init timeouts
...
### 1.127. Fixed — Documentation post-migration drift sweep
...
### 1.128. Fixed — Manifest data_flow.calls gap for LightRAG / TEI Reranker
...
### 1.129. Fixed — LightRAG three small drift bugs
...
### 1.130. Fixed — Narrow broad except clauses in 3 bootstrapper modules
...
### 1.131. Tests — Regression-guard additions
...
### 1.134. Added (TEI Reranker service)
...
### 1.135. Added — Apache Airflow + Apache Spark cluster + Apache Zeppelin (data / apps / agents bands)
...
- **Airflow × Prometheus + Grafana** — Airflow 3.x has no built-in
  ...
  exist.
### 1.136. Added — Scala sample notebook + VS Code remote-Jupyter verification flow
...
### 1.137. Assessed — OmniVoice TTS engine (skipped pending upstream readiness)
...
### 1.138. Fixed — Drop unreachable JupyterHub + Hermes Prometheus scrape jobs
...
### 1.139. Fixed — Wrong access ports in top-level README
...
### 1.140. Fixed — Observability follow-ups: cAdvisor socket, Grafana provisioning + 11.4 bump
...
### 1.141. Fixed — Prometheus + Grafana bind-mount paths produced doubled sources
...
### 1.142. Added — Scala kernels in JupyterHub + VS Code remote-Jupyter wiring
...
### 1.143. Changed — JupyterHub `requirements.txt`
...
### 1.144. Added — observability bundle (Prometheus + Grafana)
...
### 1.145. Removed (breaking) — `external` source variants stack-wide
...
### 1.146. ComfyUI model picker — localhost/external coverage (follow-up to PR #17)
...
### 1.148. 2026-05-28 third-pass audit (follow-up to PR #12 / #13)
...
### 1.149. Architecture diagrams — skill-driven rewrite
...
### 1.150. 2026-05-27 overnight audit (second pass — follow-up to PR #11)
...
### 1.151. Known follow-ups (deferred from the 2026-05-27 repo-wide audit pass)
...
### 1.152. Added — Ray distributed-compute cluster
...
### 1.153. Changed — Localhost port override (URL → PORT migration)
...
### 1.154. Changed (Documentation consolidation — service docs live with their services, hierarchical numbering, Phase C Future content)
...
### 1.155. Changed (Architecture diagrams — data-flow model + clustered layout)
...
### 1.156. Added (Cross-service deps + diagrams — Phase B research)
...
### 1.157. Added (Cross-service deps + diagrams — Phase A foundations)
...
### 1.158. Added (Dependency vulnerability monitoring)
...
### 1.159. Added (LiteLLM Kong alias for the admin dashboard)
...
### 1.160. Added (MinIO Kong alias for the admin console)
...
### 1.161. Added (Tests for Ollama-LiteLLM-wizard catalog-sync invariants)
...
### 1.162. Fixed (Wizard Ollama-models pre-check + per-variant pulled badge)
...
### 1.163. Added (Ollama auto-import for host-side sources)
...
### 1.164. Fixed (log-stream cleanup)
...
### 1.165. Fixed (LiteLLM gateway: empty chat responses, broken tool calls, duplicate Hermes provider)
...
### 1.166. Changed (Per-service configuration modularization)
...
### 1.167. Added (config modularization safety net)
...
### 1.168. Added (Hermes Agent — auto-pick default model, embedded Chat tab, dual Ollama aliases in LiteLLM)
...
### 1.169. Added (Ollama wizard step — search box, MLX badge, cloud-only filter, tag column alignment)
...
### 1.170. Added (env-file backfill helper)
...
### 1.172. Added (MinIO artifact-tier object storage)
...
### 1.173. Added (Hermes Agent runtime)
...
### 1.174. Added (Ollama multi-select enrichments — capability tags, sizes, recency-bucket sort, filter chips)
...
### 1.175. Added (wizard rework — DB-driven model_list, live model lists, multi-select prompts)
...
### 1.177. Fixed (wizard regressions discovered + fixed during this round)
...
### 1.179. Deferred / known limitations
...
### 1.182. Changed (LiteLLM migration)

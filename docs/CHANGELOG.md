...
### 1.1. Fixed — 2026-07-15 — Startup and API safety boundaries
...
### 1.2. Added — 2026-07-13 — ComfyUI media-gateway provider
...
### 1.3. Fixed — 2026-07-13 — Synchronized three-surface documentation
...
### 1.4. Added — 2026-07-10 — Consumer manifest registration
...
### 1.5. Added — 2026-07-10 — Consumer overlay doctor
...
### 1.6. Added — 2026-07-10 — Headless consumer validation commands
...
### 1.7. Added — 2026-07-10 — Non-following start for automation
...
### 1.8. Added — 2026-07-10 — MinIO parent-owned consumer buckets
...
### 1.9. Documentation — 2026-07-10 — Consumer reference layout
...
### 1.10. Added — 2026-07-10 — Ragas RAG evaluation surface
...
### 1.11. Added — 2026-07-10 — Chonkie RAG chunking surface
...
### 1.12. Added — 2026-07-10 — External consumer env overlay
...
### 1.13. Added — 2026-07-09 — Asset worker glTF post-processing service
...
### 1.14. Added — 2026-07-09 — Hosted media gateway foundation
...
### 1.15. Added — 2026-07-09 — ComfyUI pinned core + custom-node provisioning
...
### 1.16. Added — 2026-07-09 — ComfyUI model-bundle catalog foundation
...
### 1.17. Fixed — 2026-07-07 — overnight maintenance: init quoting, bootstrapper/backend hardening, latent SQL abort
...
### 1.18. Added — 2026-07-05 — FAL cloud media provider + backend Kong auth + user Supabase migration slot
...
### 1.19. Fixed — 2026-07-05 — backend plugin requirements + install-error surfacing + env-overlay cold-start preservation
...
### 1.20. Added — 2026-07-03 — Atlas root dashboard
...
### 1.21. Fixed — 2026-07-02 — overnight maintenance hardening
...
### 1.22. Changed — 2026-06-29 — SearXNG: thin `use_default_settings` override instead of a forked settings.yml
...
### 1.23. Fixed — 2026-06-28 — post-launch service error-log cleanup (realtime crash + 3 noisy services)
...
### 1.24. Fixed — 2026-06-28 — lightrag-init `password authentication failed` — pipeline ordering (the real "stale volume" cause)
...
### 1.25. Fixed — 2026-06-28 — Cold start now regenerates the volume-baked DB passwords
...
### 1.26. Fixed — 2026-06-28 — Launch pipeline crash on the embedding dimension warning (`'function' object has no attribute 'print'`)
...
### 1.27. Fixed — 2026-06-28 — Wizard "default for chat" no longer lists embedding models
...
### 1.28. Changed — 2026-06-28 — Image-pin sweep: kill moving tags, refresh stale pins (#168 / #169 / #170)
...
### 1.29. Changed — 2026-06-28 — Batched safe Dependabot dependency-floor bumps (#167)
...
### 1.30. Added — 2026-06-27 — Brand-overridable block-art logo (`BRAND_LOGO_FILE`)
...
### 1.31. Changed — 2026-06-27 — Model catalog source-of-truth: Supabase DB → per-service YAML
...
### 1.32. Fixed — 2026-06-27 — Model-SoT follow-ups
...
### 1.33. Added — 2026-06-21 — Phase 1 reuse mechanics (`services/_user/` auto-launch + release tags)
...
### 1.34. Added — 2026-06-20 — Cloudflare Tunnel service (`cloudflared`)
...
### 1.35. Added — 2026-06-20 — On-demand backup runner (`backup`)
...
### 1.36. Added — 2026-06-20 — Secrets hygiene guard + cross-OS doc accuracy
...
### 1.37. Added — 2026-06-20 — Production-hardening profile (`--profile prod`)
...
### 1.38. Changed — 2026-06-20 — Atlas startup artwork gated behind a master switch (off by default)
...
### 1.39. Added — 2026-06-18 — Atlas brand identity: logo, wizard splash, poster
...
### 1.40. Changed — 2026-06-16 — Project renamed: GenAI Vanilla → Atlas
...
### 1.41. Fixed — 2026-06-16 overnight maintenance pass
...
### 1.44. Fixed — 2026-06-14 overnight maintenance pass (18 commits, passes 1-42)
...
### 1.45. Fixed — 2026-06-13 overnight maintenance pass (15 commits, passes 1-50)
...
### 1.46. Fixed — 2026-06-11 overnight maintenance passes 56-62 (7 commits)
...
### 1.47. Fixed — 2026-06-11 overnight maintenance passes 50-55 (5 commits)
...
### 1.48. Fixed — 2026-06-11 overnight maintenance passes 46-49 (5 commits)
...
### 1.49. Fixed — 2026-06-11 overnight maintenance passes 40-45 (6 commits)
...
### 1.50. Fixed — 2026-06-10 overnight maintenance passes 35-39 (6 commits)
...
### 1.51. Fixed — 2026-06-10 overnight maintenance pass 34 (1 commit)
...
### 1.52. Fixed — 2026-06-10 overnight maintenance passes 32-33 (2 commits)
...
### 1.53. Fixed — 2026-06-10 overnight maintenance passes 27-31 (5 commits)
...
### 1.54. Fixed — 2026-06-10 overnight maintenance pass 26 (1 commit)
...
### 1.55. Fixed — 2026-06-10 overnight maintenance passes 21-25 (4 commits)
...
### 1.56. Fixed — 2026-06-10 overnight maintenance pass 20 (1 commit)
...
### 1.57. Fixed — 2026-06-10 overnight maintenance pass 19 (1 commit)
...
### 1.58. Fixed — 2026-06-10 overnight maintenance passes 16-18 (3 commits)
...
### 1.59. Fixed — 2026-06-10 overnight maintenance pass 13 (1 commit)
...
### 1.60. Fixed — 2026-06-10 overnight maintenance pass 12 (1 commit)
...
### 1.61. Fixed — 2026-06-10 overnight maintenance pass 11 (1 commit)
...
### 1.62. Fixed — 2026-06-10 overnight maintenance pass 9 (1 commit)
...
### 1.63. Fixed — 2026-06-10 overnight maintenance pass 8 (1 commit)
...
### 1.64. Fixed — 2026-06-10 overnight maintenance pass 7 (1 commit)
...
### 1.65. Fixed — 2026-06-10 overnight maintenance pass 6 (1 commit)
...
### 1.66. Fixed — 2026-06-10 overnight maintenance pass 5 (2 commits)
...
### 1.67. Fixed — 2026-06-10 overnight maintenance pass 4 (2 commits)
...
### 1.68. Fixed — 2026-06-10 overnight maintenance pass 3 (5 commits)
...
### 1.69. Fixed — 2026-06-10 overnight maintenance pass 2 (6 commits)
...
### 1.70. Fixed — 2026-06-10 overnight maintenance pass 1 (18 commits)
...
### 1.71. Changed — 2026-06-10 overnight maintenance pass 1
...
### 1.72. Fixed — Critical bugs caught by the 2026-06-08 overnight audit
...
### 1.73. Fixed — Init container resilience (7 unbounded loops)
...
### 1.74. Fixed — Documentation drift (MinIO ports, TEI memory guide)
...
### 1.75. Fixed — Build & supply-chain hygiene
...
### 1.76. Tests — Structural regression guards
...
### 1.77. Docs — Top-level architecture diagram refreshed
...
### 1.78. Security — Auto-rotate 8 weak credential placeholders on first launch
...
### 1.79. Fixed — start.py cold-start port-clear + TUI launch flag pass-through
...
### 1.80. Fixed — LightRAG init resilience + open-webui init timeouts
...
### 1.81. Fixed — Documentation post-migration drift sweep
...
### 1.82. Fixed — Manifest data_flow.calls gap for LightRAG / TEI Reranker
...
### 1.83. Fixed — LightRAG three small drift bugs
...
### 1.84. Fixed — Narrow broad except clauses in 3 bootstrapper modules
...
### 1.85. Tests — Regression-guard additions
...
### 1.88. Added (TEI Reranker service)
...
### 1.89. Added — Apache Airflow + Apache Spark cluster + Apache Zeppelin (data / apps / agents bands)
...
- **Airflow × Prometheus + Grafana** — Airflow 3.x has no built-in
  ...
  exist.
### 1.90. Added — Scala sample notebook + VS Code remote-Jupyter verification flow
...
### 1.91. Assessed — OmniVoice TTS engine (skipped pending upstream readiness)
...
### 1.92. Fixed — Drop unreachable JupyterHub + Hermes Prometheus scrape jobs
...
### 1.93. Fixed — Wrong access ports in top-level README
...
### 1.94. Fixed — Observability follow-ups: cAdvisor socket, Grafana provisioning + 11.4 bump
...
### 1.95. Fixed — Prometheus + Grafana bind-mount paths produced doubled sources
...
### 1.96. Added — Scala kernels in JupyterHub + VS Code remote-Jupyter wiring
...
### 1.97. Changed — JupyterHub `requirements.txt`
...
### 1.98. Added — observability bundle (Prometheus + Grafana)
...
### 1.99. Removed (breaking) — `external` source variants stack-wide
...
### 1.100. ComfyUI model picker — localhost/external coverage (follow-up to PR #17)
...
### 1.102. 2026-05-28 third-pass audit (follow-up to PR #12 / #13)
...
### 1.103. Architecture diagrams — skill-driven rewrite
...
### 1.104. 2026-05-27 overnight audit (second pass — follow-up to PR #11)
...
### 1.105. Known follow-ups (deferred from the 2026-05-27 repo-wide audit pass)
...
### 1.106. Added — Ray distributed-compute cluster
...
### 1.107. Changed — Localhost port override (URL → PORT migration)
...
### 1.108. Changed (Documentation consolidation — service docs live with their services, hierarchical numbering, Phase C Future content)
...
### 1.109. Changed (Architecture diagrams — data-flow model + clustered layout)
...
### 1.110. Added (Cross-service deps + diagrams — Phase B research)
...
### 1.111. Added (Cross-service deps + diagrams — Phase A foundations)
...
### 1.112. Added (Dependency vulnerability monitoring)
...
### 1.113. Added (LiteLLM Kong alias for the admin dashboard)
...
### 1.114. Added (MinIO Kong alias for the admin console)
...
### 1.115. Added (Tests for Ollama-LiteLLM-wizard catalog-sync invariants)
...
### 1.116. Fixed (Wizard Ollama-models pre-check + per-variant pulled badge)
...
### 1.117. Added (Ollama auto-import for host-side sources)
...
### 1.118. Fixed (log-stream cleanup)
...
### 1.119. Fixed (LiteLLM gateway: empty chat responses, broken tool calls, duplicate Hermes provider)
...
### 1.120. Changed (Per-service configuration modularization)
...
### 1.121. Added (config modularization safety net)
...
### 1.122. Added (Hermes Agent — auto-pick default model, embedded Chat tab, dual Ollama aliases in LiteLLM)
...
### 1.123. Added (Ollama wizard step — search box, MLX badge, cloud-only filter, tag column alignment)
...
### 1.124. Added (env-file backfill helper)
...
### 1.126. Added (MinIO artifact-tier object storage)
...
### 1.127. Added (Hermes Agent runtime)
...
### 1.128. Added (Ollama multi-select enrichments — capability tags, sizes, recency-bucket sort, filter chips)
...
### 1.129. Added (wizard rework — DB-driven model_list, live model lists, multi-select prompts)
...
### 1.131. Fixed (wizard regressions discovered + fixed during this round)
...
### 1.133. Deferred / known limitations
...
### 1.136. Changed (LiteLLM migration)

...
### 1.2. Changed — 2026-09-18 — Reviewed nginx:alpine digest advanced to the Alpine 3.24.2 republish
...
### 1.3. Fixed — 2026-09-18 — JupyterHub image builds again after the msgpack 1.2.2 lock move (#1002)
...
### 1.4. Security — 2026-09-17 — Jenkins image refreshed to LTS 2.568.3 with a current git-lfs (#1002)
...
### 1.5. Security — 2026-09-17 — Iceberg REST catalog image takes Ubuntu's updates; fixture-jar findings reviewed (#1002)
...
### 1.6. Security — 2026-09-17 — Docling adapter and MCP server images move to python:3.12.14-slim and take Debian's updates (#1002)
...
### 1.7. Security — 2026-09-17 — Docling localhost lock moves soupsieve past two new regex advisories
...
### 1.8. Added — 2026-09-17 — Support tiers and qualification evidence for every integration (#1050)
...
### 1.9. Changed — 2026-09-17 — Release notes are generated from Conventional Commits (#968, #838)
...
### 1.10. Fixed — 2026-09-17 — Five init images build again after Alpine rotated their pinned packages (#1002)
...
### 1.11. Security — 2026-09-17 — Backend image takes Debian's published updates (#1002)
...
### 1.12. Changed — 2026-09-17 — Journey-first documentation navigation (#838)
...
### 1.13. Fixed — 2026-09-17 — asset-worker image builds again after the glTF-Transform bump
...
### 1.14. Security — 2026-09-16 — backup-init takes Alpine's published updates (#1002)
...
### 1.15. Added — 2026-09-16 — Dry-run release notes from Conventional Commits (#968 prototype)
...
### 1.16. Changed — 2026-09-16 — Dependabot batch: three Actions pins and two npm minors
...
### 1.17. Security — 2026-09-16 — Final-image scan advances past Blender's vendored Python (#1002)
...
### 1.18. Fixed — 2026-09-16 — Support links point at destinations that exist (#1049)
...
### 1.19. Added — 2026-09-16 — Critical-page completeness contract for the documentation gate (#1052)
...
### 1.20. Added — 2026-09-16 — Security policy published on all three documentation surfaces (#1047)
...
### 1.21. Fixed — 2026-09-15 — Canonical landing-page HTML links resolve on every surface (#1048)
...
### 1.22. Fixed — 2026-08-26 — Startup, shutdown, storage, and operator surfaces fail truthfully
...
### 1.23. Added — 2026-08-25 — Backend plugins can declare Kong upstream timeouts (#974)
...
### 1.24. Changed — 2026-08-23 — Wizard TUI moved to Textual 8.2.8; log pane and command summary are now drag-selectable (#535 Pass 0/1)
...
### 1.25. Security — 2026-08-22 — Airflow base image and two runtime locks carried patched advisories
...
### 1.26. Fixed — 2026-08-22 — The wizard's Ollama picker hid every model below the one you expanded
...
### 1.27. Fixed — 2026-08-22 — The three-surface docs gate validated a tree it never produced
...
### 1.28. Fixed — 2026-08-22 — Supabase tables were readable and writable without authentication
...
### 1.29. Fixed — 2026-08-22 — Every Supabase call through Kong returned 401
...
### 1.30. Fixed — 2026-08-20 — A consumer's managed host process could SIGKILL an unrelated process group
...
### 1.31. Security — 2026-08-20 — A consumer manifest could hijack any generated secret
...
### 1.32. Fixed — 2026-08-20 — Env backfill silently undid a deselect-all
...
### 1.33. Fixed — 2026-08-20 — Two consumer-manifest parsing defects
...
### 1.34. Fixed — 2026-08-20 — `.env` snapshot retention could be silently disabled
...
### 1.35. Fixed — 2026-08-20 — Subprocess output decoded with the ambient locale, crashing on one non-ASCII byte
...
### 1.36. Fixed — 2026-08-20 — `.env` snapshots accumulated without bound
...
### 1.37. Fixed — 2026-08-20 — #935 left the retired `qwen3.6` default in 26 places
...
### 1.38. Fixed — 2026-08-20 — The MCP notebook raised `NameError` for every reader
...
### 1.39. Documentation — 2026-08-20 — The changelog's `[Unreleased]` section read oldest-first at the bottom
...
### 1.40. Fixed — 2026-08-16 — The documentation landing page overstated the platform and under-rendered the tracks
...
### 1.41. Fixed — 2026-08-15 — `blender-mcp stop` could SIGKILL an unrelated process
...
### 1.42. Fixed — 2026-08-15 — The docs CI check failed on transient asset fetches, and never said so
...
### 1.43. Fixed — 2026-08-15 — `blender-mcp stop` reported failure for a process it had just killed
...
### 1.44. Added — 2026-08-15 — Consumers can declare their own managed host process (#795)
...
### 1.45. Added — 2026-08-14 — The Logs tab says when it is holding an error (#912)
...
### 1.46. Added — 2026-08-11 — Host-Ollama residency: stop a multi-model run evicting its own working set (#798)
...
### 1.47. Changed — 2026-08-11 — Default Ollama content/vision model moves to qwen3.8
...
### 1.48. Changed — 2026-08-10 — Bounded the response cache, protected the Redis queues, quantized Ollama's KV cache
...
### 1.49. Fixed — 2026-08-10 — Langfuse tracing was shipping to the public cloud; langfuse-web never went healthy (#928, #929)
...
### 1.50. Changed — 2026-08-09 — Track matrix collapsed to one generated home (#838)
...
### 1.51. Added — 2026-08-09 — Ollama parallel-serving doctor lint for host daemons (#849)
...
### 1.52. Fixed — 2026-08-09 — Wizard tab follow-ups from the #911 review (#912)
...
### 1.53. Fixed — 2026-08-09 — comfyui-krea2edit was provisionable but inert (#909)
...
### 1.54. Fixed — 2026-08-08 — Wizard UX pass from a live run (tabs, prompts, stop, base port)
...
### 1.55. Fixed — 2026-08-08 — Runtime-lock advisory refresh (pypdf, GitPython, lightning)
...
### 1.56. Changed — 2026-08-07 — Wizard splits into Setup and Logs tabs
...
### 1.57. Fixed — 2026-08-07 — Wizard command summary overflowed with many services
...
### 1.58. Added — 2026-08-05 — Consumer-declared ComfyUI custom nodes + managed-MPS install (#905)
...
### 1.59. Fixed — 2026-08-05 — Wizard Ctrl+Q detach after a launch failure
...
### 1.60. Fixed — 2026-08-05 — Backend memory/research resilience
...
### 1.61. Fixed — 2026-08-05 — Research-sources cascade-delete index
...
### 1.62. Fixed — 2026-08-05 — JupyterHub empty-notebook-dir crash-loop guard
...
### 1.63. Fixed — 2026-08-05 — Provider startup, bounded-subprocess, and supply-chain hardening
...
### 1.64. Added — 2026-07-19 — Managed headless Blender MCP source
...
### 1.65. Added — 2026-07-19 — Host model pulls for `ollama-localhost`
...
### 1.66. Added — 2026-07-19 — Endpoint exports for host media directories and the Blender bridge
...
### 1.67. Added — 2026-07-19 — Managed-MPS ComfyUI model provisioning
...
### 1.68. Added — 2026-07-19 — Declarative deployment profiles
...
### 1.69. Added — 2026-07-19 — Durable host-adaptive `<SVC>_SOURCE: auto`
...
### 1.70. Fixed — 2026-07-15 — Startup and API safety boundaries
...
### 1.71. Added — 2026-07-13 — ComfyUI media-gateway provider
...
### 1.72. Fixed — 2026-07-13 — Synchronized three-surface documentation
...
### 1.73. Added — 2026-07-10 — Consumer manifest registration
...
### 1.74. Added — 2026-07-10 — Consumer overlay doctor
...
### 1.75. Added — 2026-07-10 — Headless consumer validation commands
...
### 1.76. Added — 2026-07-10 — Non-following start for automation
...
### 1.77. Added — 2026-07-10 — MinIO parent-owned consumer buckets
...
### 1.78. Documentation — 2026-07-10 — Consumer reference layout
...
### 1.79. Added — 2026-07-10 — Ragas RAG evaluation surface
...
### 1.80. Added — 2026-07-10 — Chonkie RAG chunking surface
...
### 1.81. Added — 2026-07-10 — External consumer env overlay
...
### 1.82. Added — 2026-07-09 — Asset worker glTF post-processing service
...
### 1.83. Added — 2026-07-09 — Hosted media gateway foundation
...
### 1.84. Added — 2026-07-09 — ComfyUI pinned core + custom-node provisioning
...
### 1.85. Added — 2026-07-09 — ComfyUI model-bundle catalog foundation
...
### 1.86. Fixed — 2026-07-07 — overnight maintenance: init quoting, bootstrapper/backend hardening, latent SQL abort
...
### 1.87. Added — 2026-07-05 — FAL cloud media provider + backend Kong auth + user Supabase migration slot
...
### 1.88. Fixed — 2026-07-05 — backend plugin requirements + install-error surfacing + env-overlay cold-start preservation
...
### 1.89. Added — 2026-07-03 — Atlas root dashboard
...
### 1.90. Fixed — 2026-07-02 — overnight maintenance hardening
...
### 1.91. Changed — 2026-06-29 — SearXNG: thin `use_default_settings` override instead of a forked settings.yml
...
### 1.92. Fixed — 2026-06-28 — post-launch service error-log cleanup (realtime crash + 3 noisy services)
...
### 1.93. Fixed — 2026-06-28 — lightrag-init `password authentication failed` — pipeline ordering (the real "stale volume" cause)
...
### 1.94. Fixed — 2026-06-28 — Cold start now regenerates the volume-baked DB passwords
...
### 1.95. Fixed — 2026-06-28 — Launch pipeline crash on the embedding dimension warning (`'function' object has no attribute 'print'`)
...
### 1.96. Fixed — 2026-06-28 — Wizard "default for chat" no longer lists embedding models
...
### 1.97. Changed — 2026-06-28 — Image-pin sweep: kill moving tags, refresh stale pins (#168 / #169 / #170)
...
### 1.98. Changed — 2026-06-28 — Batched safe Dependabot dependency-floor bumps (#167)
...
### 1.99. Added — 2026-06-27 — Brand-overridable block-art logo (`BRAND_LOGO_FILE`)
...
### 1.100. Changed — 2026-06-27 — Model catalog source-of-truth: Supabase DB → per-service YAML
...
### 1.101. Fixed — 2026-06-27 — Model-SoT follow-ups

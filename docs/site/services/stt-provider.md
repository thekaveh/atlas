...
`stt-provider` is an Atlas service family in the `aggregate` category. Its implementation and service-owned documentation live under `services/stt-provider/`.
...
- Diagram SVG: [`services/stt-provider/architecture.svg`](https://github.com/thekaveh/atlas/blob/main/services/stt-provider/architecture.svg)
- Diagram HTML: [`services/stt-provider/architecture.html`](https://github.com/thekaveh/atlas/blob/main/services/stt-provider/architecture.html)

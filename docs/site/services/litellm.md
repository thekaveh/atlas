...
- Runtime calls: `supabase, redis, ollama, cloud-providers, hermes, lightrag, vllm-metal, fal, tei-reranker, otel-collector`
...
The manifest data-flow list declares runtime calls to `supabase, redis, ollama, cloud-providers, hermes, lightrag, vllm-metal, fal, tei-reranker, otel-collector`. The topology row supplies aliases and port surfaces used by the generated gateway and service references.

...
- SOURCE variables: `BACKEND_SOURCE`
...
- Runtime calls: `supabase, weaviate, litellm, comfyui, fal, n8n, ray, local-deep-researcher, celery, supavisor, tika, lightrag, minio, otel-collector`
...
The manifest data-flow list declares runtime calls to `supabase, weaviate, litellm, comfyui, fal, n8n, ray, local-deep-researcher, celery, supavisor, tika, lightrag, minio, otel-collector`. The topology row supplies aliases and port surfaces used by the generated gateway and service references.

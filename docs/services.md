...
| [hermes](../services/hermes/README.md) | Hermes (programmable AI agent) | all, gen-ai-eng | HERMES_SOURCE | container | container, localhost, disabled | litellm |
...
| [n8n](../services/n8n/README.md) | n8n (workflow automation) | all, gen-ai-eng, gen-ai-rag | N8N_SOURCE | container | container, disabled | supabase, redis, litellm |
| [openclaw](../services/openclaw/README.md) | OpenClaw (AI agent gateway) | all, gen-ai-eng | OPENCLAW_SOURCE | disabled | disabled, container, localhost | litellm |
...
| [minio](../services/minio/README.md) | MinIO (S3-compatible object storage) | all, data-eng, ml-eng, trading | MINIO_SOURCE | container | container, disabled | supabase |
...
| [weaviate](../services/weaviate/README.md) | Weaviate (vector database) | all, data-eng, gen-ai-rag | WEAVIATE_SOURCE | container | container, localhost, disabled | supabase, litellm |

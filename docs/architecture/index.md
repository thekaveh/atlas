# 8.1. Architecture Diagram Catalog
...
| [SOURCE Configuration Model](source-configuration-model.md) | Container, localhost, disabled, none, cloud-provider and managed-vLLM enablement, and adaptive-service behavior. |
